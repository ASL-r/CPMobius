...
PLAYER_MODEL_PATH="Your path to Qwen2.5-Math-7B-Instruct"
...
exp_name="qwen2.5-math-7b-instruct"
...
python3 -Xfrozen_modules=off -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.val_do_sample=False \
    ...
    +trainer.save_load_begin_steps=200 $@
