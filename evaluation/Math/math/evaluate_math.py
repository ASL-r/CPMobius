...
Reads a verl-style parquet (``math_x5.parquet``) and reports overall accuracy
using shared chat-evaluation logic in ``utils.chat_eval``.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data_path", required=True,
                        help="Path to MATH parquet (e.g. data/math_x5.parquet)")
