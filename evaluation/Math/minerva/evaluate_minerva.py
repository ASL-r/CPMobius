"""Minerva-Math evaluator.

Reads a verl-style parquet (``minerva_6x.parquet``) and reports accuracy via
the shared chat-evaluation logic in ``utils.chat_eval``.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Minerva-Math evaluation")
    parser.add_argument("--data_path", required=True,
                        help="Path to Minerva parquet (e.g. data/minerva_6x.parquet)")
