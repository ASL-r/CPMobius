"""OlympiadBench evaluator.

Reads a verl-style parquet (``olympiad_bench_3x.parquet``) and reports accuracy
via the shared chat-evaluation logic in ``utils.chat_eval``.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="OlympiadBench evaluation")
    parser.add_argument("--data_path", required=True,
                        help="Path to OlympiadBench parquet "
                             "(e.g. data/olympiad_bench_3x.parquet)")
